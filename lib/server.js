...
copy(['src', 'img', 'smoke.png'], ['dist', 'smoke.png']);
copy(['src', 'img', 'spark.png'], ['dist', 'spark.png']);
copy(['src', 'font', 'helvetiker_regular.typeface.json'], ['dist', 'helvetiker_regular.typeface.json']);
